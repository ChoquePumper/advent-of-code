#!/usr/bin/env lua
-- WARNING: This program is very slow, faster than version 1 but still slow.
...
for arrangement in GetArrangementIter(arrangement) do
	if arrangement_count % 25000 == 0 then	
...
--print("dont_remove_indexes length:", #dont_remove_indexes)
