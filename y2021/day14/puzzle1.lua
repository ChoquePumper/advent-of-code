...
function solvePart1(input_iterable, steps)
...
local function main(filename)
	...
	local part1answer = solvePart1(f:lines(), 10)
	f:close()
...
function test(test_input, steps, expected_value)
	print("Running test...")
	local answer = solvePart1(stringLineIterator(test_input), steps)
...
if arg then
	...
	CC -> N
	CN -> C]]
	test(test_input, 10, 1588) -- Run a test
