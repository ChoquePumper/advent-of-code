...
function solvePart1(input)
	...
	--printPacket(packet)
	local n_discarded = #bin_string - ended_at
	print(string.format("%d bits discarded: %d bits from input, ended at index %d", n_discarded, #bin_string, ended_at))
	-- Return the answer
	return sumVerIDs(packet)
end
...
local function main(filename)
	...
	f:close()
	local part1answer = solvePart1(input)
