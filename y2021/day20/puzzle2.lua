...
---@return number
function solvePart2(enhancement_alg, input_image)
	...
	local count_pixels_lit = printMap(map)
	...
	-- Get pixels lit
	-- Return the answer
	return count_pixels_lit --map:getCountPixelsLit()
end
...
local function main(filename)
	assert(filename)
	local part2answer = solvePart2(parseInputData(io.lines(filename)))
